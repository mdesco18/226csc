...
public class BellmanFord{
	...
	public double[] distTo; //distance of shortest path s->v
	public DirectedEdge[] edgeTo; //last edge on shortest path
	public boolean[] onQueue; //is v on the queue?
	public Queue<Integer> queue; //vertices to relax
	public int cost; // number of calls to relax
    ...
    private void findNegativeCycle() {
        ...
        for (int v = 0; v < V; v++)
            if (edgeTo[v] != null)
                spt.addEdge(edgeTo[v].u, edgeTo[v].v, edgeTo[v].weight);
